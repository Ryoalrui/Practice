...
$data = $mysqli->query('SELECT name,addr FROM pic_upload_system');
$res = array_reverse($data->fetch_all(MYSQLI_ASSOC));
// print_r($res);
?>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand hidden-sm" onclick="_hmt.push(['_trackEvent', 'navbar', 'click', 'navbar-首页'])">酷图</a>
            </div>
            ...
            <p class="masthead-button-links">
                <form class="form-inline" action="index.php" method="get">
                    <div class="form-group">
                        <input type="text" class="form-control" id="exampleInputName2" placeholder="搜索相关图片" name="key" value="">
            ...
            <form class="form-inline" action="handle.php" method="post" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br/>
                        <p>图片描述：</p><textarea class="form-control" cols="75" name="info"></textarea>
                        <br/><br/>
                        <p>
                          是否添加水印：
                          <select name="mark">
